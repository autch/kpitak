...
/*
   ...
   KbMedia Player Plugin SDK (2015/09/06 版)
...
#define SZ_KMP_TAGINFO_NAME_ORIGARTIST  "OriginalArtist" //オリジナルアーティスト
#define SZ_KMP_TAGINFO_NAME_COPYRIGHT   "Copyright"   //著作権
#define SZ_KMP_TAGINFO_NAME_COMPOSER    "Composer"    //作曲者
#define SZ_KMP_TAGINFO_NAME_PERFORMER   "Performer"   //Performer
//アルバム関係
#define SZ_KMP_TAGINFO_NAME_ALBUM       "Album"       //アルバム
#define SZ_KMP_TAGINFO_NAME_GAME        "Game"        //ゲーム名
//他
...
#define SZ_KMP_TAGINFO_NAME_DISCID      "DiscId"      //ディスクID
//
#define SZ_KMP_TAGINFO_NAME_ENCODED_BY  "Encoded By"  //Encoded By(ID3v2 の TENC)
#define SZ_KMP_TAGINFO_NAME_ENCODING_SETTINGS "Encoding Settings" //Encoding settings(ID3v2 のTSSE)
...
//のような呼び方は不要
//cszName は常に ANSI であることに注意(全角文字も使えるが推奨しない)
//
